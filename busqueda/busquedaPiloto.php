...
/* Se recibe el tipo de documento para la bsqueda */
 ...
 /* Se recibe la caadena a buscar y el tipo de busqueda (All) (Any) */
  ...
  $yaentro=false;
  if(trim($ps_RADI_NOMB))if(!strlen($inTD)) $inTD=",2";
  if(trim($ps_DOCTO))if(!strlen($inTD)) $inTD=",2";
...
$sSQL .= " WHERE dir.sgd_dir_tipo in (1$inTD) AND dir.RADI_NUME_RADI=r.RADI_NUME_RADI AND r.TDOC_CODI=td.SGD_TPR_CODIGO";
//-------------------------------
