...
{
	echo "ocultar_mod(); ";
	if ($ver_tipodoc) {echo "ver_tipodocumento();";}
...
function verDecision()
{
 ...
 function ver_tipodocuTRD(codserie,tsub)
 {
   <?php
 		...
 		$ind_ProcAnex="N";
   ?>
   window.open("./radicacion/tipificar_documento.php?nurad=<?=$verrad?>&ind_ProcAnex=<?=$ind_ProcAnex?>&codusua=<?=$codusua?>&coddepe=<?=$coddepe?>&krd=<?=$krd?>&codusuario=<?=$codusuario?>&dependencia=<?=$dependencia?>&tsub="+tsub+"&codserie="+codserie,"Tipificacion_Documento","height=500,width=750,scrollbars=yes");
 }
        ...
        <tr>
          ...
          <td height="8" width="94%" class="listado2">
            ...
            <table border=0 width=69% cellpadding="0" cellspacing="0">
              <tr>
                <td width="13%" valign="bottom" class="" ><a href='verradicado.php?<?=$hdatos ?>3' ><img src='imagenes/infoGeneral<?=$datos3?>.gif' alt='' border=0 width="110" height="25"  ></a></td>
                <td width="13%" valign="bottom" class="" ><a href='verradicado.php?<?=$hdatos ?>1' ><img src='imagenes/historico<?=$datos1?>.gif' alt='' border=0 width="110" height="25" ></a></td>
                <td width="13%" valign="bottom" class="" ><a href='verradicado.php?<?=$hdatos ?>2' ><img src='imagenes/documentos<?=$datos2?>.gif' alt='' border=0 width="110" height="25" ></a></td>
                <td width="61%" valign="bottom" class="" ><a href='verradicado.php?<?=$hdatos ?>4' ><img src='imagenes/expediente<?=$datos4?>.gif' alt='' border=0 width="110" height="25"  ></a></td>
