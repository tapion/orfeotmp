...
//if ( ! is_dir( $ruta_raiz."$carpetaBodega/plantillas/" ) )
//
//{
//    // Crea un directorio llamado plantillas
//
//    if ( mkdir ( $ruta_raiz."/$carpetaBodega/plantillas/", 0777,true ) )
//
//    {
//
//        print "Directorio ".$ruta_raiz."/$carpetaBodega/plantillas/"." creado.<br>";
//
//    }
//
//    else
...
//    {
//
//        print "No se pudo crear el directorio ".$ruta_raiz."/$carpetaBodega/plantillas/.<br>";
//
//    }
//
//}
