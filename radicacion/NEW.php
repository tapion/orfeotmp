...
if ($tip3img[1][$ent])
{
	...
	$pestana1 ="<a href='#'  onClick='pestanas(1);' class='etextomenu'><img src='../img/tip3/$imgTp1.jpg' width='110' height='25' border='0' id=remitente $descTp1><img src='../img/tip3/".$imgTp1."S.jpg' width='110' height='25' border='0' id=remitente_R $descTp1></a>";
}
...
if ($tip3img[2][$ent])
{
	...
	$pestana2= "<a href='#'  onClick='pestanas(2);' class='etextomenu'><img src='../img/tip3/$imgTp2.jpg' width='110' border='0'  id=predio $descTp2><img src='../img/tip3/".$imgTp2."S.jpg' width='110' border='0'  id=predio_R $descTp2></a>";
}
...
if ($tip3img[3][$ent])
{
	...
	$pestana3 = "<a href='#'  onClick='pestanas(3);' class='etextomenu'><img src='../img/tip3/$imgTp3.jpg' width='0.1' height='25' border='0'  id=empresa $descTp3><img src='../img/tip3/".$imgTp3."S.jpg' width='110' height='25' border='0' id=empresa_R $descTp3></a>";
}
?>
<html>
<head>
...
<?php
($ent==2) ? print "Medio Recepci&oacute;n" : print "Medio Env&iacute;o";
...
<?php
$query = "Select MREC_DESC, MREC_CODI from MEDIO_RECEPCION ORDER BY 1";
$rs=$db->conn->query($query);
$varQuery = $query;
if($rs)
{
...
<?php
	...
	*/
	($ent!=2) ? $queryWhere =" where d.depe_codi=$dependencia and d.depe_estado = 1 " : $queryWhere = " where d.depe_estado = 1 and u.usua_codi=1";
    $query = "select distinct d.DEPE_NOMB,d.DEPE_CODI from dependencia d
               join usuario u  on u.depe_codi=d.depe_codi
              $queryWhere order by 1";
    $ADODB_COUNTRECS = true;
    $rs=$db->conn->query($query);
    $numRegs = "!".$rs->RecordCount();
    $varQuery = $query;
