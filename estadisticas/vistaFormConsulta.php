...
if($tipoEstadistica==1 or $tipoEstadistica==2 or $tipoEstadistica==3 or 
	...
	$tipoEstadistica==7 or $tipoEstadistica==11 or $tipoEstadistica==12 or $tipoEstadistica==15)
{
?>
<tr id="cUsuario">
...
<?
$datosaenviar = "fechaf=$fechaf&tipoEstadistica=$tipoEstadistica&codus=$codus&krd=$krd&dependencia_busq=$dependencia_busq&ruta_raiz=$ruta_raiz&fecha_ini=$fecha_ini&fecha_fin=$fecha_fin&tipoRadicado=$tipoRadicado&tipoDocumento=$tipoDocumento&tipoPQR=$tipoPQR&resol=".$resol;
