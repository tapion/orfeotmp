...
<tr>
	<td width="20%" class='titulos2' align="left">
		NIT<input name="docu1" type="checkbox" class="select" value="1" <?=$datoss?>>&nbsp;&nbsp;
		No DE CEDULA
<?php
if($docu1 == 2) $datoss = "checked"; else $datoss= "";
?>
		<input name="docu1" type="checkbox" class="select" value="2" <?=$datoss?>><br>
		No DE REFERENCIA
<?php
...
?>
	...
	<td width="20%" class='titulos2'>
		<input type=text name=buscar_docu value='<?=$buscar_docu?>' size="11"  maxlength="9" class="tex_area">
...
?>
<tr><td width="20%" class='titulos2' align="left"> FECHA ARCHIVO &nbsp;&nbsp;&nbsp;&nbsp;  Desde  <br>&nbsp;&nbsp;&nbsp;
            <?
	...
	<script language="javascript">
  	...
  	?>
   	var dateAvailable3 = new ctlSpiffyCalendarBox("dateAvailable3", "busqueda_archivo", "fechaFini","btnDate3","<?=$fechaFini?>",scBTNMODE_CUSTOMBLUE);
			...
			<br>&nbsp;
	<script language="javascript">
	var dateAvailable4 = new ctlSpiffyCalendarBox("dateAvailable4", "busqueda_archivo", "fechaFinf","btnDate4","<?=$fechaFinf?>",scBTNMODE_CUSTOMBLUE);
...
if($buscar_ufisica!=""){
if($item2=="ENTREPANO" or $item2=="ENTREPANO"){$ufisica="e.SGD_EXP_ENTREPA LIKE '$buscar_ufisica'";$t3="and";}
elseif($item2=="CAJA"){$ufisica="e.SGD_EXP_CAJA LIKE '$buscar_ufisica'";$t3="and";}
}
else {$ufisica="";$t3="";}
if($buscar_estan!=""){
if($item3=="ENTREPANO" or $item3=="ENTREPANO"){$estan="e.SGD_EXP_ENTREPA LIKE '$buscar_estan'";$t2="and";}
elseif($item3=="CAJA"){$estan="e.SGD_EXP_CAJA LIKE '$buscar_estan'";$t2="and";}
}
else {$estan="";$t2="";}
if($buscar_entre!=""){
if($item4=="ENTREPANO" or $item4=="ENTREPANO"){$entre="e.SGD_EXP_ENTREPA LIKE '$buscar_entre'";$t1="and";}
elseif($item4=="CAJA"){$entre="e.SGD_EXP_CAJA LIKE '$buscar_entre'";$t1="and";}
}
else {$entre="";$t1="";}
if($buscar_caja!=""){
if($item5=="ENTREPANO" or $item5=="ENTREPANO"){$caja="e.SGD_EXP_ENTREPA LIKE '$buscar_caja'";$t="and";}
elseif($item5=="CAJA"){$caja="e.SGD_EXP_CAJA LIKE '$buscar_caja'";$t="and";}
}
else {$caja="";$t="";}
if($buscar_caja2!=""){
if($item6=="ENTREPANO" or $item6=="ENTREPANO"){$caja2="e.SGD_EXP_ENTREPA LIKE '$buscar_caja2'";$u1="and";}
	...
	while (!$rs->EOF)
        {
            ...
            while (!$rsr->EOF)
            {
                ...
                if(($caja1=="" or $caja1==0) and $entrepa1!="")$bus=$entrepa1;
                        ...
                        if($buscar_pxmule .debiso==$ite1 or $buscar_piso==$ite2 or $buscar_piso==$ite3 or $buscar_piso==$ite4)$perm5=4;
                        }
...
//                        {
        ?>
                            ...
                            <td class=leidos2 align="center"><b><span class=leidos2><?=$documento?></span></b></td>
                            ...
                            <td class=leidos2 align="center"><b><span class=leidos2><?=$parametro1?></span></b></td>
                            <td class=leidos2 align="center"><b><span class=leidos2><?=$parametro2?></span></b></td>
                            <td class=leidos2 align="center"><b><span class=leidos2><?=$parametro3?></span></b></td>
                            <td class=leidos2 align="center"><b><span class=leidos2><?=$parametro4?></span></b></td>
                            ...
                            <td class=leidos2 align="center"><b><span class=leidos2><?=$consecu?></span></b></td>
