...
{	$db->conn->SetFetchMode(ADODB_FETCH_ASSOC);
	...
	{	$record = array();
		...
		{	case 'Agregar':
			{   ($record['DEPE_ESTADO']==0)?$off='selected':$on='selected';
				$db->conn->BeginTrans();
					...
					if ($_POST['slc_tr'.$tmp1])
					{
                        ...
                        {     case 'oci8':
                              ...
                              default:
                                  ...
                                  $sql_rtp="select * from radicado where ".$db->conn->substr.'(radi_nume_radi,14,1)='.$tmp1." and radi_depe_radi=".$_POST['txtIdDep'];
                                  break;
	...
	switch ($error)
	{
		...
		case 9: // Error en la modificacion de la dependencia
            ...
            case 10:
                        ...
                        break;
            case 11: // Error en la eliminacion de la dependencia
