...
{	$db->conn->SetFetchMode(ADODB_FETCH_ASSOC);
	...
	{	//Creamos el vector que contiene todas las Formas de envio con su respectiva informacion.
		...
		//$Rs->Move(0);
		$Rs = $db->conn->Execute($sql);
		$slc_fenv = $Rs->GetMenu2('sls_idfenv',$_POST['sls_idfenv'],"0:&lt;&lt; SELECCIONE &gt;&gt;",false,0,"id=\"sls_idfenv\" class=\"select\" onchange=\"actualiza_datos(this.value)\"");
		$Rs->Close();
		reset($v_fenv);
	}
}
...
<tr bordercolor = "#FFFFFF">
	...
	<td class="listado2">
		...
		<tr align="center">
			...
			<td width="33%"><input class="tex_area" type="text" name="txtNombre" id="txtNombre" size="50" maxlength="40"></td>
		</tr>
		<tr>
