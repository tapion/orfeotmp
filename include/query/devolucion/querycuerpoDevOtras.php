	...
	switch($db->driver)
	{
		...
		$isql = 'select ' . "4" . '         	AS "CHU_ESTADO"
			...
			from sgd_renv_regenvio a
                                left join anexos ae on  a.radi_nume_sal=ae.radi_nume_salida and a.sgd_dir_tipo=ae.sgd_dir_tipo
			...
			where a.sgd_deve_codigo is null and a.sgd_renv_cantidad in (1,0) ' .
				$dependencia_busq1 . ' '.
				$whereDep.
				$dependencia_busq2 . '
