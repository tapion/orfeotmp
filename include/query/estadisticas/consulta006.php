...
if(isset($_GET['genDetalle'])&& $_GET['denDetalle']=1){
		$titulos=array("#","1#RADICADO","2#FECHA RADICACION","3#TIPO DE DOCUMENTO","4#USUARIO ACTUAL","5#ASUNTO","6#REMITENTE","7#DIAS RESTANTES","8#SECTOR");
	}else{ 		
...
function pintarEstadisticaDetalle($fila,$indice,$numColumna){
			...
			switch ($numColumna){
					...
					case 4:
						...
						break;
					case 5:
						$salida="<left class=\"leidos\">".$fila['ASUNTO']."</left>";
						break;
					case 6:
