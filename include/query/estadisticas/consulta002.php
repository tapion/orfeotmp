	...
	case 'postgres':
		{	if ( $dependencia_busq != 99999)
			...
			$queryE = "SELECT c.mrec_desc AS MEDIO_RECEPCION, COUNT(*) AS Radicados, max(c.MREC_CODI) AS HID_MREC_CODI
					...
					WHERE 
						h.usua_doc=b.usua_doc and h.radi_nume_radi=r.radi_nume_radi and h.sgd_ttr_codigo=2
			...
			$queryEDetalle = "SELECT $radi_nume_radi 								AS RADICADO, 
					...
					FROM RADICADO r, USUARIO b, MEDIO_RECEPCION c , hist_eventos h
					WHERE 
						h.usua_doc=b.usua_doc and h.radi_nume_radi=r.radi_nume_radi and h.sgd_ttr_codigo=2
						AND r.mrec_codi=c.mrec_codi
...
if(isset($_GET['genDetalle'])&& $_GET['denDetalle']=1)
	$titulos=array("#","1#MEDIO DE RECEPCION","2#FECHA RADICADO","3#ASUNTO","4#ANEXOS","5#NO HOJAS","6#MEDIO DE RECEPCION","7#USUARIO");
else 		
