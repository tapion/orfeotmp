...
switch($db->driver)
	...
	$queryEDetalle = "SELECT $radi_nume_radi as RADICADO, r.RADI_FECH_RADI as FECHA_RADICACION,
		s.SGD_TPR_DESCRIP as TIPO_DOCUMENTO,
		h.HIST_FECH as FECHA_HISTORICO, h.HIST_OBSE as OBSERVACION,
	...
	$queryEDetalle = "SELECT r.RADI_NUME_RADI as RADICADO, r.RADI_FECH_RADI as FECHA_RADICACION,
		s.SGD_TPR_DESCRIP as TIPO_DOCUMENTO,
		h.HIST_FECH as FECHA_HISTORICO, h.HIST_OBSE as OBSERVACION,
		 b.USUA_NOMB as USUARIO, d.DEPE_NOMB as DEPENDENCIA,r.radi_path as HID_RADI_PATH{$seguridad}
		FROM RADICADO r, HIST_EVENTOS h, DEPENDENCIA d, USUARIO b, 
