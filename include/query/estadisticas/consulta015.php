...
$anexos=$db->conn->Concat("a.RADI_NUME_SALIDA","' '",$db->conn->substr."(a.SGD_DIR_TIPO,2,2)");//$db->conn->substr."(a.ANEX_CODIGO,15,5)");                   
...
if(isset($_GET['genDetalle'])&& $_GET['genDetalle']==1 || isset($_GET['genTodosDetalle'])&& $_GET['genTodosDetalle']==1)
	$titulos=array("#","1#RADICADO","2#FECHA RADICADO","3#ASUNTO","4#DEPENDENCIA_PQR","5#MEDIO_RECEPCION","6#ANEXO","7#USUARIO_CREADOR","8#DEPENDENCIA_ACTUAL");
else
