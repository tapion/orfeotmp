...
{	case 'postgres':
	...
	case 'ocipo':
		{	$sSQL_1 = "select r.radi_nume_radi 										AS RAD_ENTRADA, 
			...
			/** CONSULTA PARA VER DETALLES 
			 */
			$sSQL = $sSQL_1 . $sWhereFecE . $resolucion . " UNION " . $sSQL_2 . $sWhereFecE. $resolucion . " UNION " .  $sSQL_3 . $sWhereFecE . $resolucion . $sOrder;
			$queryEDetalle = $sSQL . $orderE;	
		}break;
}
...
function pintarEstadistica($fila,$indice,$numColumna){
        	...
        	switch ($numColumna){
        		...
        		break;
        		case 2:
        			$datosEnvioDetalle="tipoEstadistica=".$_POST['tipoEstadistica']."&amp;genDetalle=1&amp;usua_doc=".urlencode($fila['HID_USUA_DOC'])."&amp;dependencia_busq=".$_POST['dependencia_busq']."&amp;fecha_ini=".$_POST['fecha_ini']."&amp;fecha_fin=".$_POST['fecha_fin']."&amp;tipoRadicado=".$_POST['tipoRadicado']."&amp;tipoDocumento=".$_POST['tipoDocumento']."&amp;codUs=".$fila['HID_COD_USUARIO']."&amp;fecSel=".$fila['HID_FECH_SELEC']."&amp;resol=".$_POST['resol'];
