...
<TABLE width="450" class="borde_tab" cellspacing="5">
  ...
  <tr>
    ...
    <?php $sqlfenv="select  ".$db->conn->Concat("sgd_fenv_codigo","'-'"," sgd_fenv_descrip").",sgd_fenv_codigo from sgd_fenv_frmenvio where sgd_fenv_planilla =1 and sgd_fenv_estado=1 order by 2";
