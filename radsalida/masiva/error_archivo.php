...
?>
<p class=etexto> <span class='etextomenu'>Al archivo CSV le faltan algunas columnas obligatorias en sus registros
  :<BR>
  <?  
...
if (count($auxErrLugar)>0)  {
  ...
  datos: <BR>
   ...
   $num = count($auxErrESP);
	...
	?>
  Los siguientes datos de las direcciones tienen tama&ntilde;o mayor de 95 caracteres<BR>
   	<?  
   $num = count($auxErrorDir);
	...
	?>
	 Los siguientes datos de nombres tienen tama&ntilde;o mayor de 95 caracteres<BR>
   	<?  
