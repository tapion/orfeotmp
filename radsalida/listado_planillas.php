...
// Si la variable $generar_listado_existente viene entonces este if genera la planilla existente
    ...
    $pdf->SetFont('Arial', '', 8);
    $pdf->AliasNbPages();
    $head_table = array("CANTIDAD", "CATEGORIA DE CORRESPONDENCIA", "RADICADO", "DESTINATARIO", "DESTINO", "PESO EN GRAMOS", "VALOR PORTE", "CERTIFICADO", "VALOR ASEGURADO", "TASA DE SEGURO", "VALOR REEMBOLSABLE", "AVISO DE LLEGADA", "SERVICIOS ESPECIALES", "VALOR TOTAL PORTES Y TASAS");
