    ...
    if($generar_informe)
    {
        ...
        */
        ...
        $generar_informe = 'generar_informe';
            ...
            $campos_width = array (200          ,110        ,280           ,250        ,70        ,70            ,70          ,80          );
...
<TABLE width="550" class='borde_tab'>
  <!--DWLayoutTable-->
  <TR>
    <TD width="415" height="21"  class='titulos3'> Fecha desde<br>
	<?
	  echo "($fecha_busq)";
	?>
	</TD>
    <TD width="415" align="left" class='titulos5'>
  ...
  <TR>
    <TD width="125" height="21"  class='titulos3'> Fecha Hasta<br>
	<?
	  echo "($fecha_busq2)";
	?>
	</TD>
...
?>
 ...
 <?
	...
	$encabezado = "<table border=1>
			...
			<tr>
			<td width=1120 height=30>REPORTE DE DOCUMENTOS ENVIADOS ENTRE $fecha_busq   $hora_ini:$minu_ini:$seg_ini  y $fecha_busq2   $hora_fin:$minu_fin:$seg_fin </td>
			</tr>
			</table>";
	$fin = "<table border=1 bgcolor='#FFFFFF'>
        ...
        $encabezado = iconv($odt->codificacion($encabezado), 'ISO-8859-1',$encabezado);
        $html = iconv($odt->codificacion($html), 'ISO-8859-1',$html);
        $pdf->WriteHTML($encabezado .$html . $fin);
	$arpdf_tmp = "../bodega/pdfs/planillas/envios/".$dependencia."_".$krd. date("Ymd_hms") . "_envio.pdf";
