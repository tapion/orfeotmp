...
if($radicadosCarrito !== ""){
    $radicadosCarrito = trim(trim($radicadosCarrito),",");
    $radicadosCarrito = explode(",",$radicadosCarrito);
    $radicadosCarrito = array_filter($radicadosCarrito, "is_numeric");
    $radicadosCarrito = implode(",", $radicadosCarrito);
}
...
$radicadosCarrito = (empty($radicadosCarrito)) ? '0' : $radicadosCarrito;

//Ajuntar resultado a la consulta de de radicados                                 
$whereCarrito = "AND b.RADI_NUME_RADI IN($radicadosCarrito)";
