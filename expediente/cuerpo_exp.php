...
$dependencia_busq1= " and d.sgd_exp_estado=$tipo_archivo and $wdep_sel  and (upper(d.sgd_exp_numero) like '%$buscar_exp%' and upper(d.RADI_NUME_RADI) like '%$buscar_rad%'";
...
while(!$rs->EOF)
{
	if($ki>=$registro and $ki<($registro+20))
	{
	     ...
	     */
	     ...
	     {
		 	$urlimagen = "<a href='../bodega/".$rs->fields["RADI_PATH"]."'><span class='".$class."'>$data</span></a>";
	     }
	     else
