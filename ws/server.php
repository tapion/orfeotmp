                        ...
                        )
{
    ...
    {   //2a validacion. Que los datos brindados sean validos en tipologia (y longitud).
        ...
        if ($validaOk)
        {
            ...
            $datos_r['CARP_CODI'] = 0;
            $datos_r['TDOC_CODI'] = 0;
            $datos_r['RA_ASUN'] = htmlspecialchars(stripcslashes(substr($AsuntoRadicado, 0, 320)));
            ...
            $sql_r = "INSERT INTO RADICADO ".
                    "(CARP_PER,CARP_CODI,TDOC_CODI,RA_ASUN,TRTE_CODI,MREC_CODI,RADI_FECH_OFIC,RADI_USUA_ACTU,RADI_DEPE_ACTU,RADI_FECH_RADI,RADI_USUA_RADI,RADI_DEPE_RADI,CODI_NIVEL,FLAG_NIVEL,RADI_LEIDO,SGD_APLI_CODIGO,SGD_APLI_ENLACE,RADI_NUME_RADI) ".
                    "VALUES ".
                    "(0, 0, 0, '".htmlspecialchars(stripcslashes(substr($AsuntoRadicado, 0, 320)))."', $Tercero, 3, ".$conn->DBDate($fechaRadicado).", 1, $depe_destino, ".$conn->sysTimeStamp.", $usua_radi, $depe_destino, $usua_nivel, 1, 0, $cod_app, '".htmlspecialchars(stripcslashes(substr($referencia, 0, 16)))."',$newRadicado)";
