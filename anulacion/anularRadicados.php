...
require_once($ruta_raiz."/radsalida/masiva/OpenDocText.class.php");
	...
	$fecha_hoy =  $b->traducefecha($date);
  	$html = "<table width='100%' align='left'><tr><td></td></tr><tr><td colspan=3 >&nbsp;&nbsp; &nbsp;&nbsp;</td><td align='left'><b>".strtoupper($entidad_largo)."</b></td></tr></table>
		<p><p>
		<br><br><br>
		<b><center> &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
		&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 
		...
		por el Archivo General de la Naci&oacute;n, en el cual se establecen pautas para la administraci&oacute;n de
		las  comunicaciones  oficiales en las  entidades  p&uacute;blicas  y  privadas  que cumplen  funciones
		p&uacute;blicas, y con base especialmente en  el  par&aacute;grafo del Art&iacute;culo Quinto, el cual establece que
		Cuando existan errores  en  la  radicaci&oacute;n  y  se anulen los n&uacute;meros, se debe dejar constancia
		por escrito, con la   respectiva justificaci&oacute;n y firma del Jefe de la unidad de correspondencia; el
		Coordinador de  Gesti&oacute;n Documental y Correspondencia de $entidad_largo procede  a   anular   los   siguientes  n&uacute;meros  de  radicaci&oacute;n  de
		...
		$usua_nomb<BR>
		Centro de Gesti&oacute;n Documental y Correspondencia.";
  	$ruta_raiz = "..";
	$pdf=new PDF();
	$pdf->Open();
