...
$depTDR = $rs->fields['DEPE_CODI'];   //Dependencia
	while(!$rs->EOF and $rs)
	{
			...
			}else
			{
				...
				<td><center><font size=2 face='Arial'>$pSBRD</font></center><br>";
				$openTR = "Si";
				...
				<td><center><font size=2 face='Arial'>$conservE</font></td>
				<td><center><font size=2 face='Arial'>$conservI</td>
				<td><center><font size=2 face='Arial'>$conservS</td>";
                                foreach ($medioSoporte as $i){
