	...
	/////si autentica por bd****************
		 ...
		 if ($ordenar==0 && $verClave==1 && $nover!=1) 
            ...
            if($rs && !$rs->EOF) { $enviar=1; }
			   ...
			   echo "<script> alert('La contrase\xF1a del usuario solicitante es incorrecta'); </script>"; 
               $enviar=0;
				}			
		 	} 
		}
...
<? } ?>
    ...
    function setSel(start,end){
	   ...
	   else { alert('Su browser no soporta las funciones Javascript de esta página.'); }
    } 	
